...
$fields = array('name' => '', 'email' => '@domain.com', 'message' => '', 'check' => '');
$errors = array();
$is_success = false;
...
if( isset($_POST['submit']) )
{
	...
	{
	  $errors[] = 'The phone number field must have a numeric value.';
	}//end if
...
<p><label for="name">Name: *</label> <input type="text" name="name" id="name" value="<?php print $fields['name']; ?>"
maxlength="255" size="40" /></p>

<p><label for="email">Email: *</label> <input type="text" name="email" id="email" value="<?php print $fields['email']; ?>"
maxlength="255" size="40" /></p>

<p><label for="phone">Phone:</label> <input type="text" name="phone" id="phone" value="<?php print $fields['phone']; ?>"
maxlength="255" size="40" /></p>

<p><label for="message">Message: *</label> <textarea name="message" id="message" 
cols="10" rows="10"><?php print $fields['message']; ?></textarea></p>
