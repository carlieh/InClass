...
function my_page_initializer() {
	...
	$site_config['show_get'] = isset($_GET['show_get']) ? ((bool) $_GET['show_get']) : false; //ternary operator
...
<ul>
	<li><a href="get-array1.php" title="Home">Home</a></li>
	<li><a href="get-array1.php?page=about" title="About">About</a></li>
	<li><a href="get-array1.php?page=contact" title="Contact">Contact</a></li>
</ul>
